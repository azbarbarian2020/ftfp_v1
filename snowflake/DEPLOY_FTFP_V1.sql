...
-- ============================================================================
-- PHASE 6: CREATE STAGE AND LOAD SEED DATA
-- ============================================================================
-- This phase creates an internal stage for seed data files.
-- 
-- ⚠️ IMPORTANT: Before continuing, upload the seed data files to this stage:
--    
--    Using Snowflake CLI:
--      snow stage put seed_data/*.csv.gz @FTFP_V1.FTFP.SEED_STAGE --overwrite
--
--    Or using SnowSQL:
--      PUT file://path/to/seed_data/*.csv.gz @FTFP_V1.FTFP.SEED_STAGE;
--
--    Or upload via Snowsight UI: Data > Databases > FTFP_V1 > FTFP > Stages > SEED_STAGE
-- ============================================================================
SELECT '📦 Phase 6: Creating stage for seed data...' AS STATUS;

USE SCHEMA FTFP;

-- Create internal stage for seed data files
...
SELECT '✅ Phase 6: Stage created' AS STATUS;
SELECT '⚠️ PAUSE HERE: Upload seed data files to @FTFP_V1.FTFP.SEED_STAGE before continuing' AS INSTRUCTIONS;
SELECT 'Run: snow stage put seed_data/*.csv.gz @FTFP_V1.FTFP.SEED_STAGE --overwrite --connection YOUR_CONNECTION' AS COMMAND;

-- ============================================================================
-- PHASE 6B: LOAD SEED DATA (run after uploading files to stage)
-- ============================================================================
-- Uncomment and run this section AFTER uploading the CSV files to the stage

-- Check what files are in the stage
LIST @SEED_STAGE;
...
SELECT '✅ Phase 6B: Seed data loaded' AS STATUS;
